...
<body class="bg-background text-slate-800 font-sans antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-primary-dark text-white flex flex-col z-20 shadow-xl">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1.5">
            <a href="{{ route('portal.dashboard') }}" class="flex items-center px-4 py-3 bg-emerald-800/60 rounded-xl text-emerald-50 font-medium transition shadow-sm border border-emerald-700/50">
            ...
            <a href="#" class="flex items-center px-4 py-3 rounded-xl text-emerald-200 hover:bg-emerald-800/40 hover:text-white transition font-medium">
            ...
            <a href="#" class="flex items-center justify-between px-4 py-3 rounded-xl text-emerald-200 hover:bg-emerald-800/40 hover:text-white transition font-medium">
        ...
        <div class="p-4 border-t border-emerald-800/50">
            <div class="flex items-center px-2 mb-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-emerald-300 truncate">Minha Conta</p>
                </div>
            </div>
            <form method="POST" action="{{ route('portal.logout') }}">
                @csrf
                <button type="submit" class="w-full flex items-center justify-center px-4 py-2 bg-emerald-800/40 hover:bg-red-500/80 rounded-lg text-emerald-100 hover:text-white transition text-sm font-medium">
