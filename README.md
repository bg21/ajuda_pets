...
- **⚖️ Controle de Peso:** Registro histórico contínuo, permitindo que o tutor insira o peso atualizado do pet sempre que quiser para acompanhar seu desenvolvimento.
...
- [ ] **Sistema de Alertas e Lembretes:** Notificações por e-mail/WhatsApp alertando sobre o vencimento de vacinas, vermífugos e antipulgas, além de um **lembrete mensal** automático para o tutor pesar o pet.
...
6. Inicie o servidor de desenvolvimento:
   ...
   php artisan serve
   ```
   *E não esqueça de rodar o Vite em outro terminal caso precise compilar assets:* `npm run dev`
